	...
	<div class="container container-white">
		...
		<div class="row col-sm-12">
			...
			<c:if test="${(isEditor || isAdmin)}">
				<div class="col-sm-4">
					<h5><a class="btn btn-link btn-xs" href="<c:url value='/admin/approval'/>"><span class="badge" style="background-color:#337ab7">${recipeApprovals}</span></a>
					<strong><spring:message code="dashboard.approvalrequired"></spring:message></strong>&nbsp;						
					</h5>	
					<h5><a class="btn btn-link btn-xs" href="<c:url value='/admin/comments'/>"><span class="badge" style="background-color:#337ab7">${flaggedComments}</span></a>
					<strong><spring:message code="dashboard.flaggedcomments"></spring:message></strong>&nbsp;						
					</h5>
					<h5><a class="btn btn-link btn-xs" href="<c:url value='/admin/ingredients'/>"><span class="badge" style="background-color:#337ab7">${ingredientReviews}</span></a>

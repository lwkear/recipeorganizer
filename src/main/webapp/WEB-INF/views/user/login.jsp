	 	...
	 	<div class="col-sm-12">
			...
			<div class="row">
				<form name="loginForm" action="<c:url value='/user/login'/>" method="post">
			        <div class="row">
						<label class="control-label col-sm-5 col-sm-offset-4" for="username">
			        ...
			        <div class="row">
						<div class="form-group col-sm-4 col-sm-offset-4">
							<div class="checkbox-inline">
								<input class="" type="checkbox" id="rememberMe" name="rememberMe"/><strong>
									<spring:message code="login.rememberme"></spring:message></strong>
							</div>
						</div>
					</div>
					<div class="form-group col-sm-4 col-sm-offset-4">

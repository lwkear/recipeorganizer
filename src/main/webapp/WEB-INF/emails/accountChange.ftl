      		...
      		<tr>
    			<td>
					...
					<table width="614" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
						<tr>
							<td width="16" height="28"><img src="cid:cleargif" border="0" style="display:block" width="16" height="28"/></td>
							<td width="11" bgcolor="#7e8e82"></td>
							<td width="556" align="left" valign="middle" bgcolor="#7e8e82">
								<font face="Arial, Helvetica, sans-serif" color="#ffffff" style="font-size: 18px; line-height: 55px;">${accountChange}</font></td>
					...
					<table width="614" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="578" height="24"><img src="cid:cleargif" style="display: block" width="578" height="24"/></td>
							<td width="18" height="24"><img src="cid:cleargif" style="display: block" width="18" height="24"/></td>
						</tr>
						<tr>
							<td></td>
						...
						<tr>
							<td height="1"></td>
							<td width="578" height="1" bgcolor="#999999" background="cid:cleargif"></td>
							<td height="1"></td>
						</tr>
					</table>
					<table width="614" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td width="18" height="10"><img src="cid:cleargif" style="display: block" width="18" height="10"/></td>
							<td width="18" height="10"><img src="cid:cleargif" style="display: block" width="18" height="10"/></td>
							<td width="530" height="10"><img src="cid:cleargif" style="display: block" width="530" height="10"/></td>
							<td width="30" height="10"><img src="cid:cleargif" style="display: block" width="30" height="10"/></td>
							<td width="18" height="10"><img src="cid:cleargif" style="display: block" width="18" height="10"/></td>
						</tr>
						<tr>
							<td height="10"></td>

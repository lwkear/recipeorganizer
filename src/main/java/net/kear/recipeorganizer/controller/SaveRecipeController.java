...
public class SaveRecipeController {
	...
	//display a blank recipe form
	@RequestMapping("recipe/addRecipe")
	public String addRecipe(Locale locale, Model model, HttpSession session) {
	...
	//save a recipe
	@RequestMapping(value="recipe/addRecipe", method = RequestMethod.POST)
	public String saveRecipe(Model model, @ModelAttribute @Valid Recipe recipe, BindingResult result, BindingResult resultSource,
		...
		logger.info("Source Type = " + recipe.getSources().get(0).getType());
		...
		//test return with previously entered recipe
		//model.addAttribute("ingredientList", recipeService.getIngredients(recipe));			
		//return "recipe/addRecipe";
	}
	

	//display an existing recipe edit form
	@RequestMapping("recipe/editRecipe/{id}")
	public String editRecipe(Locale locale, Model model, @PathVariable Long id, HttpSession session) {
	...
	public String updateRecipe(Model model, @ModelAttribute @Valid Recipe recipe, BindingResult result, BindingResult resultSource,
			//@RequestParam(value = "file", required = false) MultipartFile file, HttpSession session, SessionStatus status) {
			@RequestParam(value = "file", required = false) MultipartFile file, HttpSession session) {		
